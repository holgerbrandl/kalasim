<llm-snippet-file>D:/projects/scheduling/kalasim/docs/userguide/docs/examples/emergency_room.ipynb</llm-snippet-file>
...
Recent portrayals of emergency medicine, such as [The Pitt](https://www.imdb.com/title/tt31938062/), highlight the intensity of hospital workflows. While dramatized, they remind us how resource-constrained these environments are and how small decisions can cascade into major consequences. This motivated the simplified model developed here.

![image.png](thepitt.png){: .center}

<p align="center">
<i> © Warner Bros. Discovery <a href="https://press.wbd.com/na/property/pitt/images"> Source</a></i>
</p>

In this article, we construct a simulation model of an emergency room to understand its dynamics and identify opportunities for improvement. The goal is to analyze how scheduling rules, resource constraints, and system interactions influence performance. See [Günal 2010](https://www.tandfonline.com/doi/abs/10.1057/jos.2009.25?journalCode=tjsm20) for an excellent review of related work.
...
The conceptual framework for this model was inspired by [Kramer et al. (2019)](todo reference):
...
Patients are classified in two ways:
1. **Severity**: The ER uses the [Emergency Severity Index](https://en.wikipedia.org/wiki/Emergency_Severity_Index) to triage patients based on acuity and anticipated resource needs.
2. **Type of Injury**: Defined based on standard [medical classifications](https://medlineplus.gov/woundsandinjuries.html).
...
We aim to explore if we can also:
* Minimize overall waiting times.
* Reduce the frequency of surgery room re-configurations (setups).
...
![jpeg](emergency_room_files/emergency_room_9_0.jpg)
...
![jpeg](emergency_room_files/emergency_room_12_0.jpg)
...
![jpeg](emergency_room_files/emergency_room_16_0.jpg)
...
![jpeg](emergency_room_files/emergency_room_18_0.jpg)
...
![jpeg](emergency_room_files/emergency_room_20_0.jpg)
...
![jpeg](emergency_room_files/emergency_room_22_0.jpg)
...
body::-webkit-scrollbar-track {
    background-color: var(--scroll-bg);
        ...
        &lt;&sol;head&gt;
        &lt;body&gt;
            &lt;table class=&quot;dataframe&quot; id=&quot;df_-2013265912&quot;&gt;&lt;&sol;table&gt;
...
], id: -2013265912, rootId: -2013265912, totalRows: 10 } ) });
&sol;*--&gt;*&sol;
...
body::-webkit-scrollbar-track {
    background-color: var(--scroll-bg);
        ...
        &lt;&sol;head&gt;
        &lt;body&gt;
            &lt;table class=&quot;dataframe&quot; id=&quot;df_-2013265908&quot;&gt;&lt;&sol;table&gt;
...
], id: -2013265908, rootId: -2013265908, totalRows: 5 } ) });
&sol;*--&gt;*&sol;
