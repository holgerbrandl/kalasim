...
@RequiresOptIn(level = RequiresOptIn.Level.WARNING, message = "This API is not recommended and deprecated in kalasim (v0.12+). Extend org.kalasim.Component directly. It's strongly encouraged to use kotlinx.datetime Instant instead of Number to configure and express times in your simulation model.")
@Retention(AnnotationRetention.BINARY)
